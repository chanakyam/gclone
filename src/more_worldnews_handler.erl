...
welcome(Req, State) ->
	...
	Url_more_news = gclone_util:more_worldnews(Category, integer_to_list(?NEWS_PER_PAGE), integer_to_list(SkipItems)), 	
	% io:format("Url_more_news ~p ~n ",[Url_more_news]),
	...
	{ok, Body} = more_worldnews_dtl:render([{<<"videoParam">>,VideoParams},{<<"news_category">>,Category},{<<"allnews">>,ParamsAllNews}]),
    {Body, Req, State}.
